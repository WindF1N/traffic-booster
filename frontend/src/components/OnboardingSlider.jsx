            ...
            {slides.map((slide, index) => (
              <div key={index} className="relative h-screen w-[100%] flex-shrink-0 px-[20px] pt-[2.33%] oveflow-hidden">
                ...
                <>
                  ...
                  <div className="rounded-[100%] rotate-[14.43deg] w-[45.6%] h-[5%] absolute bottom-[21.27%] right-0 left-0 mx-auto ml-[22%] blur-[15px] z-[-1] bg-[#0C0C0C] will-change-transform"></div>
                </>}
                {index === 2 && 
