  ...
  return (
    <div className="fixed flex flex-col h-[100%] w-[100%] max-w-[420px] mx-auto bg-[rgba(0,0,0,0.8)] left-0 right-0 top-0 z-[4]">
        <div className="relative flex flex-col bg-[#282828] rounded-[10px] w-[calc(100%-40px)] h-[61.33%] m-auto p-[15px] overflow-hidden">
            ...
            <img className="absolute z-[4] w-[75.42%] bottom-[-7.39%] right-[-24%]" src={images['./assets/3d-raster.png']} alt="" />
            <img className="cursor-pointer absolute z-[4] right-[15px] top-[15px] w-[32px] h-[32px]" src={images['./assets/close.svg']} alt="" onClick={() => setIsOpen(false)} />
        </div>
    </div>
  );
}
