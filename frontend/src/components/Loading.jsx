...
function Loading() {
  ...
  return (
    <div className="relative flex flex-col h-screen overflow-hidden">
      ...
      <h1 className="font-[600] text-[72px] text-[#FFF] leading-none mt-[15%] mr-[26px] ml-auto">Traffic<br/><span className="text-[#FFD900] flex center">Bo<img className="h-[72px]" src={images['./assets/flame.png']} alt=""/>ster</span></h1>
      <img 
