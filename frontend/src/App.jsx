...
function App() {
  ...
  useEffect(() => {
    if (isLoading) {
      const initData = window.Telegram?.WebApp?.initData || "user=%7B%22id%22%3A453500861%2C%22first_name%22%3A%22object%20nss%22%2C%22last_name%22%3A%22%22%2C%22username%22%3A%22thecreatxr%22%2C%22language_code%22%3A%22ru%22%2C%22allows_write_to_pm%22%3Atrue%7D&chat_instance=2590400874092330745&chat_type=group&auth_date=1725651669&hash=c952be40b82914386e5e4899eb8b71a378252e7fe62e814cdcb30cdcbe0b3aeb";
      if (initData) {
