    ...
    <>
      <div className="relative flex flex-col h-screen overflow-x-hidden pb-[120px]">
        ...
        <div className="px-[20px] mt-[20px]">
          <div className="bg-[rgba(117,117,117,0.1)] p-[10px] rounded-[10px] flex justify-between relative overflow-hidden" onClick={() => setIsOpen(true)}>
            <div>
        ...
        <div className="flex flex-wrap gap-[10px] px-[20px] pt-[10px]">
          <div className="relative overflow-hidden bg-[rgba(117,117,117,0.1)] rounded-[10px] p-[10px] w-[calc(50%-5px)]" onClick={() => setIsOpen(true)}>
      ...
      {isOpen && <TaskPopUp setIsOpen={setIsOpen} />}
    </>
  );
}
