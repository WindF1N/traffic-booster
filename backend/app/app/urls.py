...
from main.views import (
    ...
    AdvertisersViewSet, TariffsViewSet, WalletsViewSet, GameKeysViewSet, GamesViewSet, TelegramAuthView, AccountInfoView, CharactersView, SyncBalanceView, TasksView
)
